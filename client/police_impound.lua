                            ...
                            onSelect = function ()
                                ...
                                if not checkkDate then
                                    local alert = lib.alertDialog({
                                        header = ("Olá %s"):format(fw.gn()),
                                        content = ("O tempo de apreensão deste veículo ainda é de %s dias. Deseja retirar o veículo mesmo assim?"):format(day),
                                        centered = true,
                                        cancel = true,
                                        labels = {
                                            confirm = "Confirmar",
            ...
            options = {
                {
                    ...
                    onSelect = function ()
                        ...
                        local success = lib.callback.await('rhd_garage:server:payFine', false, fine)
                        if success then
                            paid = true
                            continue = true
                            utils.notify("Multa paga com sucesso!", "success")
                        else
                            continue = true
                        end
                    end
